<header class="home">
	<div class="container">
		<div style="margin-top: 50px;">
			<div class="row">
				<div class="col-md-12">
					<h1 class="nome-topo"> Peter Clayder </span> </h1>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
			...
			<div class="row" >
				<div class="col-md-12 animateLink">
					<center>
						<a  titulo="Clique aqui" href="#sobre" style="position: relative; top: 20px; color: #48d09b"> <i class="fa fa-arrow-circle-down fa-3x" aria-hidden="true"></i></a>
					<center>
				</div>
			</div>
		</div>
